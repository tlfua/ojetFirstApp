 ...
 */
export declare const fireRejectAction: (messages: ComponentMessageItem[], isDrag: boolean, onReject?: ((detail: RejectDetail) => void) | undefined) => undefined;
/**
 * Calls the onCommit callback when all files are valid.
 */
export declare const handleFilesAdded: (files: FileList, onCommit?: ((detail: CommitDetail) => void) | undefined) => void;
