 ...
 */
export declare function MeterCircle({ max, min, value, step, size, startAngle, angleExtent, isTrackRendered, thresholdDisplay, indicatorSize, ...props }: MeterProps): import("preact").JSX.Element;
