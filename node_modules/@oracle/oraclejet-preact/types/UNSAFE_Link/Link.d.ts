...
export declare function Link({ href, variant, placement, target, 'aria-describedby': ariaDescribedBy, 'aria-label': accessibleLabel, 'aria-labelledby': ariaLabelledBy, children, onClick }: Props): import("preact").JSX.Element;
export {};
