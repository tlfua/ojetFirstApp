...
declare const colorSchemeVars: {
    ...
    textIcon: {
        ...
        infoLow: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
        warningLow: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
        dangerLow: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    };
    collection: {
        header: {
...
declare const collectionVars: {
    listRowHeight: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    listCellPaddingVertical: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    sparkleImg: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
};
...
declare const globalVars: {
    currentBackgroundColor: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    gutterStart: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    gutterEnd: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
};
declare const vars: {
    label: {
        sm: {
...
export { vars, baseVars, colorSchemeVars, typographyVars, PREFIX, animationVars, scaleVars, htmlVars, bodyVars, collectionVars, dvtVars, globalVars };
