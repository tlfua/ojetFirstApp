...
export class OjLegendBase extends OjWebElement {
   ...
   *
   */
  public getSectionTitleStyle(): Promise<object> {
    return this.getProperty<object>('sectionTitleStyle');
  }
...
export interface Sections {
   ...
   * @deprecated Since 14.1.0. This attribute is deprecated. Applications should use the expanded API on oj-legend instead
   */
  expanded: string;
  /**
...
export interface Translations {
   ...
   * @deprecated Since 15.0.0. This is deprecated because it is not used by the oj-legend
   */
