...
class OjTreeView extends OjTreeViewBase_1.OjTreeViewBase {
    ...
    async changeExpanded(expanded) {
        ...
        ele.expanded = expandedKeySet;`, this, expanded);
        await this.whenBusyContextReady();
    }
    /**
