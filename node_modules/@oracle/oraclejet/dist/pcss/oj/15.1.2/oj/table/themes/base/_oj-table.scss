...
@include module-include-once("common.table") {
  ...
  /* selection borders for column selection when vertical grid lines are enabled. */
  ...
  .oj-table-column-header-cell.oj-table-vgrid-lines.oj-selected:not(.oj-table-frozen-end.oj-table-frozen-edge):not(.oj-table-column-resize-indicator):not(.oj-helper-hidden-accessible) + .oj-table-column-header-cell,
  .oj-table-data-cell.oj-table-vgrid-lines.oj-selected:not(.oj-table-frozen-end.oj-table-frozen-edge):not(.oj-table-column-resize-indicator):not(:first-child):not(.oj-helper-hidden-accessible),
  .oj-table-data-cell.oj-table-vgrid-lines.oj-selected:not(.oj-table-frozen-end.oj-table-frozen-edge):not(.oj-table-column-resize-indicator):not(.oj-helper-hidden-accessible) + .oj-table-data-cell,
  ...
  .oj-table-footer-cell.oj-table-vgrid-lines.oj-selected:not(.oj-table-frozen-end.oj-table-frozen-edge):not(.oj-table-column-resize-indicator):not(.oj-helper-hidden-accessible) + .oj-table-footer-cell,
  ...
  .oj-table-add-row-placeholder > td.oj-table-vgrid-lines.oj-selected:not(.oj-table-frozen-end.oj-table-frozen-edge):not(.oj-table-column-resize-indicator):not(.oj-helper-hidden-accessible) + td {
  ...
  .oj-table:not(.oj-focus) .oj-table-footer-cell.oj-selected.oj-hover {
    background-image: linear-gradient(var(--oj-collection-header-bg-color-selected), var(--oj-collection-header-bg-color-selected)),
     linear-gradient(var(--oj-collection-header-bg-color-hover), var(--oj-collection-header-bg-color-hover));
  }
  ...
  /* Styling for the column resize indicator on a column. */
  ...
  .oj-table-sort-icon-container.oj-active .oj-component-icon {
    color: var(--oj-core-text-color-secondary);
  }
  ...
  /* Styling for the data cell elements in selected and hover state when table focused. */
  ...
  /* Styling for the data cell elements in selected and hover state when table not focused. */
  ...
  .oj-table-element:not(.oj-focus) .oj-table-gutter-end-body-cell.oj-selected.oj-hover {
    background-image: linear-gradient(var(--oj-core-bg-color-hover), var(--oj-core-bg-color-hover)),
      linear-gradient(var(--oj-core-bg-color-selected), var(--oj-core-bg-color-selected));
  }
