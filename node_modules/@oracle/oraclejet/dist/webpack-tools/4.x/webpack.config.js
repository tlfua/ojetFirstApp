...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/15.1.2/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/15.1.2/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/15.1.2"
      }
    )
